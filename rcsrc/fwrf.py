...
### https://github.com/styvesg/fwrf/blob/master/fwrf_analysis_template.ipynb
...
def model_space_tensor(
    ...
    '''mst_data, mst_avg, mst_std = fwrf.model_space_tensor(fmaps, sharedModel_specs, nonlinearity=log_act_func, \
                zscore=True, trn_size=trn_size, epsilon=1e-6, batches=(200, nx*ny), view_angle=lx, verbose=True, dry_run=False)
